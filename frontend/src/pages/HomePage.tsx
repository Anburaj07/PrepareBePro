  ...
  return (
    <div className="p-8 text-center">
        {/* <div className="max-w-[800px] mt-[-96px] w-full h-[82vh] mx-auto text-center px-6 flex flex-col justify-center">
            ...
            <p className='md:text-2xl sm:text-xl text-lg font-bold text-gray-500'>Practice your technical interview and get valuable feedback immediatly!</p>
        </div> */}
        <h1 className="text-[#5d8de9] md:text-5xl sm:text-4xl text-3xl font-bold md:py-6">ACE YOUR INTERVIEWS</h1>
        <p className='text-[#8b9707] md:text-2xl sm:text-xl text-lg font-bold '>Practice your technical interview and get valuable feedback immediatly!</p>
